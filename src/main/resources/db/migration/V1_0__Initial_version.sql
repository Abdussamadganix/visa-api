...
CREATE TABLE `payment` (
  ...
  `bill_id_format` varchar(32) NOT NULL DEFAULT '' COMMENT 'Unique key of organisation',
  `ref_id` varchar(32) NOT NULL DEFAULT '' COMMENT 'Unique key of organisation',
  `other_phone_number` varchar(32) NOT NULL DEFAULT '' COMMENT 'Unique key of organisation',
  `other_email_address` varchar(32) NOT NULL DEFAULT '' COMMENT 'Unique key of organisation',
  `enc_merchant_pan` varchar(32) NOT NULL DEFAULT '' COMMENT 'Unique key of organisation bank',
  `enc_consumer_name` varchar(32) NOT NULL DEFAULT '' COMMENT 'Unique key of recipient',
  `amount` decimal(20,2) NOT NULL COMMENT 'Amount paid in cents',
  `transaction_fee_amount` decimal(20,2) NOT NULL COMMENT 'Amount paid in cents',
  `transaction_amount` decimal(20,2) NOT NULL COMMENT 'Amount paid in cents',
  `currency` varchar(10) DEFAULT NULL COMMENT 'Currency of payment',
  `message_type` varchar(50) NOT NULL COMMENT 'message type of payment',
  `auth_id_response` varchar(50) NOT NULL COMMENT 'auth id response of payment',
  `response_code` varchar(50) NOT NULL COMMENT 'auth id response of payment',
  `rejection_code` varchar(50) NOT NULL COMMENT 'auth id response of payment',
  `enc_consumer_pan` varchar(50) NOT NULL COMMENT 'auth id response of payment',
  `transmission_date_time` varchar(50) NOT NULL COMMENT 'auth id response of payment',
  `system_trace_audit_number` varchar(50) NOT NULL COMMENT 'auth id response of payment',
  `local_transaction_time` varchar(50) NOT NULL COMMENT 'auth id response of payment',
  `local_transaction_date` varchar(50) NOT NULL COMMENT 'auth id response of payment',
  `originator_country_code` varchar(50) NOT NULL COMMENT 'auth id response of payment',
  `originator_bin` varchar(50) NOT NULL COMMENT 'auth id response of payment',
  `retrieval_reference_number` varchar(50) NOT NULL COMMENT 'auth id response of payment',
  `transaction_currency_code` varchar(50) NOT NULL COMMENT 'auth id response of payment',
  `visa_transaction_id` varchar(50) NOT NULL COMMENT 'auth id response of payment',
  `decimal_position_indicator` varchar(50) NOT NULL COMMENT 'auth id response of payment',
  `enc_agent_name` varchar(50) NOT NULL COMMENT 'auth id response of payment',
  `agent_city` varchar(50) NOT NULL COMMENT 'auth id response of payment',
