...
import com.visa.service.visa.auth.ApiKeyAuth;
import com.visa.service.visa.auth.Authentication;
import com.visa.service.visa.auth.HttpBasicAuth;
import com.visa.service.visa.auth.OAuth;
import com.visa.service.visa.configuration.VisaConfiguration;
import com.visa.service.visa.model.response.EncryptedResponse;
import com.visa.service.visa.util.CustomInstantDeserializer;
import com.visa.service.visa.util.RFC3339DateFormat;
...
@javax.annotation.Generated(value = "io.swagger.codegen.languages.java.JavaClientCodegen", date = "2018-12-19T10:49:18.818+05:30[Asia/Kolkata]")
@Component("com.visa.developer.sample.mvisa_api.ApiClient")
public class ApiClient {
  ...
  public ApiClient(VisaConfiguration configuration,
      RestTemplateBuilder restTemplateBuilder,
      RestTemplateErrorHandler restTemplateErrorHandler) {
    this.configuration = configuration;
    this.basePath = configuration.getBaseUrl();
...
//
  ...
  public boolean isJsonMime(MediaType mediaType) {
    return mediaType != null && (MediaType.APPLICATION_JSON.isCompatibleWith(mediaType) || mediaType
        .getSubtype().matches("^.*\\+json[;]?\\s*$"));
  }
   ...
   */
  protected Object selectBody(Object obj, MultiValueMap<String, Object> formParams,
    ...
    if (authentications.containsKey("keyId")) {
      try {
        obj = EncryptionUtils
            .getEncryptedPayload(obj, ((ApiKeyAuth) authentications.get("keyId")).getKeyId());
      } catch (Exception e) {
        e.printStackTrace();
      }
    }
   ...
   */
  public <T> T invokeAPI(String path, HttpMethod method, Object body,
      ParameterizedTypeReference<T> returnType, Class<T> returnClassType)
    ...
    final List<MediaType> accept = selectHeaderAccept(accepts);
    final String[] contentTypes = {};
    final MediaType contentType = selectHeaderContentType(contentTypes);

    String[] authNames = new String[]{"basicAuth"};

    updateParamsForAuth(authNames, queryParams, headerParams, path, body);
...
//      ResponseEntity<EncryptedResponse> responseEntity = restTemplate.exchange(requestEntity, encryptedResponseType);
  ...
  protected RestTemplate buildRestTemplate() {
    if (this.restTemplate == null) {
      RestTemplate restTemplate =
          authentications.containsKey("basicAuth") ? getRestTemplateForMutualAuth()
  ...
  private void updateParamsForAuth(String[] authNames, MultiValueMap<String, String> queryParams,
      HttpHeaders headerParams, String resourcePath, Object requestBody) {
    try {
  ...
  static class EncryptionUtils {
    ...
    public static String getEncryptedPayload(Object payload, String keyId)
    ...
    public static <T> T getDecryptedPayload(EncryptedResponse encryptedPayload,
        Class<T> returnType) {
    ...
    */
    private static PrivateKey getRSAPrivateKey()
      ...
      String pemEncodedKey = IOUtils
          .readFileToString(new File(mleClientPrivateKeyPath), Charset.forName("UTF-8"));
      Base64 base64 = new Base64(
          pemEncodedKey.replaceAll(BEGIN_RSA_PRIVATE_KEY, "").replaceAll(END_RSA_PRIVATE_KEY, ""));
    ...
    */
    private static RSAPublicKey getRSAPublicKey() throws CertificateException, IOException {
      String pemEncodedPublicKey = IOUtils
          .readFileToString(new File(mleServerPublicCertificatePath), Charset.forName("UTF-8"));
      Base64 base64 = new Base64(
