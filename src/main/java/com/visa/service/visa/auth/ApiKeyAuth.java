...
---------------------------------------------------------------------------------------------------------------------- */
package com.visa.service.visa.auth;
...
public class ApiKeyAuth implements Authentication {
  ...
  public void generateAndSetXpaytoken(MultiValueMap<String, String> queryParams,
      String resourcePath, Object requestBody) throws SignatureException, JsonProcessingException {
  ...
  private String getDigest(String algorithm, String sharedSecret, String data, boolean toLower)
      throws SignatureException {
    try {
      Mac sha256HMAC = Mac.getInstance(algorithm);
      SecretKeySpec secretKey = new SecretKeySpec(sharedSecret.getBytes(StandardCharsets.UTF_8),
          algorithm);
